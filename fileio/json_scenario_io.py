...
def load_scenario_json(path: Path) -> Scenario:
    ...
    scenario = Scenario(
        ...
        servers=int(model_payload.get("servers", 1)),
        ordering_type=str(model_payload.get("ordering_type", "counter_only")),
        ...
        kiosk_usage_percent=float(model_payload.get("kiosk_usage_percent", 0.0)),
        kiosk_order_time_min=int(model_payload.get("kiosk_order_time_min", 0)),
        kiosk_order_time_max=int(model_payload.get("kiosk_order_time_max", 0)),
        kiosk_order_time_mean=float(model_payload.get("kiosk_order_time_mean", 0.0)),
        kiosk_order_time_sd=float(model_payload.get("kiosk_order_time_sd", 0.0)),
