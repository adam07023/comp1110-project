...
def write_scenario_file(path: Path, scenario: Scenario) -> None:
    ...
    lines = [
        ...
        f"order_min={scenario.counter_order_time_min}",
        f"order_max={scenario.counter_order_time_max}",
        f"order_mean={scenario.counter_order_time_mean}",
        f"order_sd={scenario.counter_order_time_sd}",
        "",
        "[reservations]",
