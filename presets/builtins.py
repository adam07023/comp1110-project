...
def get_builtin_models() -> dict[str, BusinessModel]:
    return {
        "fast_food": BusinessModel(
            ...
            kiosk_order_time_min=2,
            kiosk_order_time_max=5,
            kiosk_order_time_mean=3,
            kiosk_order_time_sd=1,
            reservation_policy="none",
            arrival_pattern="uniform",
            patience_threshold_mean=15.0,
            patience_threshold_sd=5.0,
            notes="Quick turnover with one counter and three kiosks. No reservations.",
        ),
        ...
        "cafe": BusinessModel(
            ...
            notes="Solo and pair dominant. Three ordering counters. No reservations.",
        ),
